...
@WebServlet("/EvaLikeIncrease")
public class EvaLikeIncrease extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 평가글 좋아요 클릭 시 증가 INSERT문
		try {
			dDao.evaIncrease(mm_idx, eva_idx);
		...
		System.out.println(love_eva_idx);

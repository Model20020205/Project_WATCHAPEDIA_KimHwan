...
@WebServlet("/StarDeleteEvaluation")
public class StarDeleteEvaluation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 별점 삭제 (DELETE)
		System.out.println("DELETE POST 요청 들어옴.");
		
		// 별점 가져오기
		int score = Integer.parseInt(request.getParameter("starAvg"));
		...
		// 취소하기 클릭 시 값 INSERT
		try {
			dDao.starDelete(mm_idx, movie_idx);

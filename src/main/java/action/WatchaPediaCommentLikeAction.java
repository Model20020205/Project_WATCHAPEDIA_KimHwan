...
public class WatchaPediaCommentLikeAction implements Action {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 왓챠피디아 좋아요 내림차순 코멘트 더보기 Action
		System.out.println("코멘트 더보기 좋아요 내림차순 도착");
		...
		ArrayList<MoreCommentDto> showLike = new ArrayList<MoreCommentDto>();
		try {
			showLike = dDao.showScroll(movie_idx, pageNum);
		} catch(Exception e) { e.printStackTrace(); }
		...
		request.getRequestDispatcher("WatchaPedia_More_List.jsp").forward(request, response);
	}
